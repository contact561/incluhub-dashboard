...
export function AdminReviewForm({
  ...
  return (
    <section className="rounded-xl border border-zinc-200 bg-white p-5">
      <h2 className="text-base font-semibold text-zinc-900">Admin decision</h2>
      <p className="mt-1 text-sm text-zinc-500">
        Approve to complete this portfolio and unlock the next step, or request
        a revision with clear feedback for the portfolio leader.
      </p>
